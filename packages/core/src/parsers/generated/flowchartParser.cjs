...
exports.parser = flowchartParser;
exports.Parser = flowchartParser.Parser;
exports.parse = function () { return flowchartParser.parse.apply(flowchartParser, arguments); };
