...
exports.parser = mindmapParser;
exports.Parser = mindmapParser.Parser;
exports.parse = function () { return mindmapParser.parse.apply(mindmapParser, arguments); };
