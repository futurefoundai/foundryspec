...
*/
var requirementParser = (function(){
...
exports.parser = requirementParser;
exports.Parser = requirementParser.Parser;
exports.parse = function () { return requirementParser.parse.apply(requirementParser, arguments); };
