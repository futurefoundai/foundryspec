...
export interface ProjectConfig {
    ...
    created: string;
    lastBuild?: string;
    categories: Array<{  //TODO: Categories are dynamic so they should not be set in static mould, the system should automatically detect the folders that have things in them, is that not what is already done?
        name: string;
        path: string;
        description: string;
    }>;
